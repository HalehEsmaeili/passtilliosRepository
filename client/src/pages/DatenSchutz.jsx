...
function Impressum () {
  ...
  return (
    <div style={{marginTop:"35%",margin:"10%"}}>
  
  <div>
      <h1 className="datenschutzH" style={{color:"#00eeb9"}}>Datenschutzerklärung</h1>
      <p >
        <strong className="datenschutzpNum">1. Allgemeine Hinweise und Grundsätze der Datenverarbeitung</strong>
      </p>
      ...
      <p className="datenschutzp">
        Wir erklären Ihnen zudem die Art und den Umfang der jeweiligen Datenverarbeitung, den Zweck und die entsprechende Rechtsgrundlage sowie die jeweilige Speicherdauer.
      </p>
      <p className="datenschutzp">
      ...
      <p>
        <strong className="datenschutzpNum">2. Verantwortliche Stelle</strong>
      </p>
      <p className="datenschutzp">
        Verantwortlich für die Verarbeitung von personenbezogenen Daten auf dieser Webseite ist (vgl. Impressum).
      </p>
      <p >
        <strong className="datenschutzpNum">3. Bereitstellung und Nutzung der Webseite/ Server Logfiles</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      <p className="datenschutzp">
      ...
      <ul className="datenschutzp">
        <li style={{color:"white"}}>IP-Adresse</li>
        <li style={{color:"white"}}>Datum und Uhrzeit der Anfrage</li>
        <li style={{color:"white"}}>Name und URL der abgerufenen Datei</li>
        <li style={{color:"white"}}>Website, von der aus der Zugriff erfolgt (Referrer-URL)</li>
        <li style={{color:"white"}}>Zugriffsstatus/HTTP-Statuscode</li>
        <li style={{color:"white"}}>Browsertyp</li>
        <li style={{color:"white"}}>Sprache und Version der Browsersoftware</li>
        <li style={{color:"white"}}>Betriebssystem</li>
      </ul>
      <p >
        <strong className="datenschutzpNum">b) Zweck und Rechtsgrundlage</strong>
      </p>
      <p className="datenschutzp">
      ...
      <p className="datenschutzp">
        Rechtsgrundlage für diese Verarbeitung ist Art. 6 Abs. 1 lit. f) DS-GVO. Die Verarbeitung der genannten Daten ist für die Bereitstellung einer
      </p>
    </div> <div>
      <h1>Datenschutzerklärung</h1>
      <p>
        <strong className="datenschutzpNum">34. Einsatz von Cookies</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art, Umfang und Zweck der Datenverarbeitung</strong>
      </p>
      <p className="datenschutzp">
      ...
      <p>
        <strong className="datenschutzpNum">35. Datenerhebung zur Durchführung vorvertraglicher Maßnahmen und zur Vertragserfüllung</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      ...
      <p >
        <strong className="datenschutzpNum">36. Bestellformular</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      ...
      <p>
        <strong className="datenschutzpNum">37. Registrierungsmöglichkeit</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      ...
      <p className="datenschutzp">
        <strong>38. Datenübermittlung</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      ...
      <p>
        <strong className="datenschutzpNum">39. Bewerbungsmöglichkeit</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      ...
      <p >
        <strong className="datenschutzpNum">40. Kommentarfunktion</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      ...
      <p className="datenschutzp">
        <strong className="datenschutzpNum">41. Kontaktformular</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      ...
      <p>
        <strong className="datenschutzpNum">42. Kontaktmöglichkeiten per E-Mail</strong>
      </p>
      <p>
        <strong className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</strong>
      </p>
      ...
      <div>
      <h1 className="datenschutzpNum">KontaktList</h1>
      <div>
        <h1 className="datenschutzpNum">a) Art und Umfang der Datenverarbeitung</h1>
        <p className="datenschutzp">
          Auf unserer Webseite besteht die Möglichkeit, einen kostenfreien regelmäßigen E-Mail Newsletter zu abonnieren. Um Ihnen regelmäßig den Newsletter zusenden zu können, benötigen wir von Ihnen ihre E-Mail-Adresse.
          <br /><br />
      ...
      <div>
        <h1 className="datenschutzpNum">b) Zweck und Rechtsgrundlage</h1>
        <p className="datenschutzp">
      ...
      <div>
        <h1 className="datenschutzpNum">c) Speicherdauer</h1>
        <p className="datenschutzp">
    ...
    <div>
      <h1 className="datenschutzpNum">14. Tracking- und Analysetools</h1>
      <p className="datenschutzp">Eine exakte Übersicht zu den von uns verwendeten Web Analyse- und Social Media Tools finden Sie hier.</p>

      <h1 className="datenschutzpNum">15. Datensicherheit und Sicherungsmaßnahmen</h1>
      <p className="datenschutzp">Wir verpflichten uns, Ihre Privatsphäre zu schützen und Ihre personenbezogenen Daten vertraulich zu behandeln. Dazu treffen wir umfangreiche technische und organisatorische Sicherheitsvorkehrungen, welche regelmäßig überprüft und dem technologischen Fortschritt angepasst werden.</p>
      <p className="datenschutzp">Hierzu gehört unter anderem die Verwendung anerkannter Verschlüsselungsverfahren (SSL oder TLS). Unverschlüsselt preisgegebene Daten, beispielsweise wenn dies per unverschlüsselter E-Mail erfolgt, können aber eventuell von Dritten mitgelesen werden. Darauf haben wir keinen Einfluss. Es liegt im Verantwortungsbereich des jeweiligen Nutzers, die von ihm zur Verfügung gestellten Daten durch Verschlüsselung oder in sonstiger Weise gegen Missbrauch zu schützen.</p>

      <h1 className="datenschutzpNum">16. Änderungen der Datenschutzerklärung</h1>
      <p>Wir behalten uns jederzeit das Recht vor, diese Erklärung bei Bedarf entsprechend zu aktualisieren.</p>

      <h1 className="datenschutzpNum">17. Ihre Rechte</h1>
      <p className="datenschutzp">Hier finden Sie Ihre Rechte in Bezug auf Ihre personenbezogenen Daten. Einzelheiten dazu ergeben sich aus den Artikeln 7, 15-22 und 77 DS-GVO. Sie können sich diesbezüglich an die verantwortliche Stelle (Ziff. 2).</p>
      <p className="datenschutzp">Recht auf Widerruf Ihrer datenschutzrechtlichen Einwilligung nach Art. 7 Abs. 3 S. 1 DS-GVO</p>
      <p className="datenschutzp">...</p> {/* The remaining points (a) to (h) should be added similarly */}
    </div>
    </div>
  );
}
