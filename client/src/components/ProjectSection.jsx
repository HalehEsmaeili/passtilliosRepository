...
import { motion,useInView, useMotionValueEvent, useScroll,useAnimate,useAnimationControls, useMotionValue,useAnimation } from "framer-motion";
...
<motion.img ref={img1} id="personNotTalking"   animate={controls}  transition={{duration:0.05, 
  ...
  <motion.img ref={img2} src={throatCleaning} alt="person" animate={controlsimg2} ></motion.img>
