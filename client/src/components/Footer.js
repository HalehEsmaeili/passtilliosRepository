...
function Footer() {
    ...
    return (
      ...
      <Link to="/Impressum" className="button" style={{  }}>
        <p style={{ position:"relative",display: 'inline-block', textAlign: 'center',color:"#00eeb9",marginLeft:"30%",fontSize:"2vw"  }} className="mt-5 mb-3 text-body-secondary">Impressum</p>
      </Link>
